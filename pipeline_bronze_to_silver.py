...
rejected_products.to_csv(OUT+"silver_rejected_products.csv", index=False)
products.to_csv(OUT+"silver_products.csv", index=False)
...
employees.to_csv(OUT+"silver_employees.csv", index=False)
...
shippers.to_csv(OUT+"silver_shippers.csv", index=False)
...
customers.to_csv(OUT+"silver_customers.csv", index=False)
...
promotions.to_csv(OUT+"silver_promotions.csv", index=False)
...
geography.to_csv(OUT+"silver_geography.csv", index=False)
city_regions.to_csv(OUT+"silver_city_regions.csv", index=False)
district_regions.to_csv(OUT+"silver_district_regions.csv", index=False)
...
returns.to_csv(OUT+"silver_returns.csv", index=False)
...
reviews.to_csv(OUT+"silver_reviews.csv", index=False)
...
inventory.to_csv(OUT+"silver_inventory.csv", index=False)
...
check_fk(order_items,
    ...
    "order_items")
order_items.to_csv(OUT+"silver_order_items.csv", index=False)
...
payments.to_csv(OUT+"silver_payments.csv", index=False)
...
shipments.to_csv(OUT+"silver_shipments.csv", index=False)
...
orders.to_csv(OUT+"silver_orders.csv", index=False)
