...
# geography khong con luu san cot region (da chuan hoa ve city_regions/district_regions rieng)
# -> kiem tra thay the: moi city/district trong geography phai tra ve duoc region qua join
check_subset(geography["city"], city_regions["city"], "geography", "city_regions", "city")
check_subset(geography["district"], district_regions["district"], "geography", "district_regions", "district")
