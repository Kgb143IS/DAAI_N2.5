...
ENTITIES = {
    "geography": {
        ...
        "output_path": "./silver_data/geography.csv",
        "primary_key": "zip",
        "date_columns": [],
        "column_mapping": {
            "zip": "zip",
    ...
    "shipper": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/shippers.csv",
    ...
    "promotion": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/promotions.csv",
    ...
    "product": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/products.csv",
    ...
    "customer": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/customers.csv",
    ...
    "order": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/orders.csv",
    ...
    "order_item": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/order_items.csv",
    ...
    "return": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/returns.csv",
    ...
    "employee": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/employees.csv",
    ...
    "payment": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/payments.csv",
        "primary_key": "order_id",
        "date_columns": [],
        "column_mapping": {
            "order_id": "order_id",
    ...
    "shipment": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/shipments.csv",
    ...
    "review": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/reviews.csv",
    ...
    "inventory": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/inventory.csv",
    ...
    "city_region": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/city_regions.csv",
        "primary_key": "city",
        "date_columns": [],
        "column_mapping": {
            "city": "city",
    ...
    "district_region": {
        "raw_path": RAW_FILE_PATH, 
        "output_path": "./silver_data/district_regions.csv",
    ...
    # Thêm entity mới ở đây, ví dụ:
    # "products": {
    #     "raw_path": "/home/claude/data/raw_products.csv",
    #     "output_path": "/home/claude/data/silver_products.csv",
    #     "primary_key": "product_id",
    #     "date_columns": [],
    #     "column_mapping": {
    #         "product_id": "product_id",
